import type { Testimonial } from "@/components/trips/TestimonialSlider";

export const familyReviews: Testimonial[] = [
  {
    id: "family-1",
    name: "Carlos Rodríguez",
    location: "3 weken geleden",
    comment:
...
export const sunsetReviews: Testimonial[] = [
  {
    id: "sunset-1",
    name: "Sophie Martin",
    location: "1 maand geleden",
    comment:
...
export const snorkelingReviews: Testimonial[] = [
  {
    id: "snorkel-1",
    name: "John Smith",
    location: "1 maand geleden",
