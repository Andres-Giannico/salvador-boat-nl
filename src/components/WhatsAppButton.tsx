...
const WhatsAppButton = () => {
  const phoneNumber = businessContact.whatsappNumber; // Número actualizado

  return (
    <motion.a
      href={`https://wa.me/${phoneNumber}?text=Hallo, ik wil graag een boottocht boeken bij Salvador Ibiza`}
      target="_blank"
    ...
    >
      <div className="flex items-center bg-green-600 text-white p-3 rounded-full shadow-lg hover:bg-green-700 transition-colors group">
        ...
        <span className="hidden md:block ml-2 font-medium">Chat met ons</span>
      </div>
    </motion.a>
  );
};
